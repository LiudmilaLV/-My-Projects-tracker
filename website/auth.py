...
def sign_up():
    if request.method == 'POST':
        ...
        if user:
            ...
            flash('Email must be greater than 3 charachters.', category='warning')
        elif len(name)  < 2:
            flash('Name must be greater than 1 charachters.', category='warning')
        elif password1 != password2:
            flash('Passwords don\'t match', category='warning')
        elif len(password1) < 7:
            flash('Password must be at least 8 charachters.', category='warning')
        else:
