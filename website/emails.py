...
def confirm_mail_text(token):
	...
	<body style="margin:0;background-color:#ecf0f1;">
		...
		<table class="main" width="100%" style="background-color:#ffffff;margin:0 auto;width:100%;max-width:600px;border-spacing:0;font-family:sans-serif;color:#4a4a4a;">
			<tr>
			<td height="8" style="padding:0;background-color: #2c3e50;"></td>
			</tr>
			<tr>
			<td style="padding:0;padding: 14px 0 4px;">
				...
				<tr>
					...
					<table class="column" style="border-spacing:0;width:100%;max-width:300px;display:inline-block;vertical-align:center;">
						<tr>
						<td style="padding:0;padding: 0 0 10px 50px;">
							<a href="https://yourprojecttracker.com/"><img src="https://i.ibb.co/zSNnw1V/ypt-logo2-1.jpg" alt="Logo" width="80" title="Logo" style="border:0;"></a>
						</td>
						</tr>
					</table>
					<table class="column" style="border-spacing:0;width:100%;max-width:300px;display:inline-block;vertical-align:center;">
						<tr>
						<td style="padding:0;">
							<p style="font-size: 26px; font-weight: bold; padding: 0 40px 0 0;"><a style="text-decoration: none; color: #2c3e50;" href="https://yourprojecttracker.com/">Your Project Tracker</a></p>
						</td>
						</tr>
					</table>
					</td>
			...
			<tr>
			<td height="1" style="padding:0;background-color: #2c3e50;"></td>
			</tr>
			<tr>
			<td style="padding:0;padding: 5px 0 50px;">
				<table width="100%" style="border-spacing:0;">
				<tr>
					<td style="padding:0;text-align: center; padding: 15px 0 0 0;">
